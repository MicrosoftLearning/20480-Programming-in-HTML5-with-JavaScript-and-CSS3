...
3.	In the **New Project** dialog box, in the left pane, under **Templates** expand the **Visual C#** node, and then click the **Web** node.
4.	In the middle pane, click **ASP.NET Empty Web Application**.
5.	In the **Name** box, type **ContosoConf**.
6.	In the **Location** box, type **Allfiles\Mod02\Labfiles\Starter\Exercise 1**, and then click **OK**.
