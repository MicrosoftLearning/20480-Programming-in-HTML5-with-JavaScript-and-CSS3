...
6.	In the **Location** box, enter **Allfiles\Mod02\Labfiles\Starter\Exercise 1**, and then click **OK**.
...
4.	Click **Add**.
5.	From the **Allfiles\Mod02\Labfiles\Starter\Exercise 1\Resources** folder, open the **index.txt** file in Notepad.
6.	In Visual Studio, return to the Design view, which displays the **Source** view for the **index.htm** file.
...
4.	Click **Add**.
5.	From the **Allfiles\Mod02\Labfiles\Starter\Exercise 1\Resources** folder, open **about.txt** file in Notepad.
6.	In Visual Studio, return to the Design view, which displays the **Source** view for the **about.htm** file.
