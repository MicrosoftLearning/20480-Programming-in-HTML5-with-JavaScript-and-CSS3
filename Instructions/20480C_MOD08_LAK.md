...
4.	On the Windows taskbar, click **File Explorer**, and then browse to **Allfiles\Mod08\Labfiles\Resources**.
...
3.	In Microsoft Edge, if the **localhost wants to track your location** message appears, click **Allow once**.
