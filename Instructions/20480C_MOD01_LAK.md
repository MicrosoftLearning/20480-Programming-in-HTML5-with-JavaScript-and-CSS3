...
1.	In Microsoft Visual Studio, in **Solution Explorer**, expand the **ContosoConf** project.
...
9.	Verify that the following scripts are referenced:
  ```html
    <script src="/dist/offline.bundel.js" type="text/javascript"></script>
    <script src="/dist/video.bundel.js" type="text/javascript"></script>
  ```
...
17.	Verify that this element contains the following HTML markup:
  ...
  ```
18.	Verify that the **schedule.htm** file contains the **&lt;script src="/dist/schedule.js" type="text/javascript"&gt;** element near the end.
...
23.	Verify that the **location.htm** file contains the **&lt;script src="/dist/location.bundel.js" type="text/javascript"&gt;** element near the end.
...
31.	Verify that the **live.htm** file contains the following **&lt;script&gt;** element near the end:
  ```html
    <script src="/dist/live.bundel.js" type="text/javascript">
  ```
...
35.	Verify that the **feedback.htm** file contains the following **&lt;script&gt;** elements near the end:
  ```html
    <script src="/dist/feedback.bundel.js" type="text/javascript">
  ```
