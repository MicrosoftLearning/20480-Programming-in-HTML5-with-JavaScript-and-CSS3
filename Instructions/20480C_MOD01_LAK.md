...
9.	Verify that the following scripts are referenced:
  ```html
    ...
    <script src="/scripts/_namespace.js" type="module"></script>
    <script src="/scripts/datetime.js" type="module"></script>
...
17.	Verify that this element contains the following HTML markup:
  ...
  ```
18.	Verify that the schedule.htm file contains the **&lt;script src="/scripts/pages/schedule.js" type="module"&gt;** element near the end.
...
23.	Verify that the location.htm file contains the **&lt;script src="/scripts/pages/location.js" type="module"&gt;** element near the end.
...
31.	Verify that the live.htm file contains the following **&lt;script&gt;** element near the end:
  ```html
    <script src="/scripts/pages/live.js" type="module">
  ```
...
35.	Verify that the feedback.htm file contains the following **&lt;script&gt;** elements near the end:
  ```html
    <script src="/scripts/StarRatingView.js" type="module">
    <script src="/scripts/pages/feedback.js" type="module">
  ```
