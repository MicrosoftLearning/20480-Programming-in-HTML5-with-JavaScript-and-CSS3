...
9.	Verify that the following scripts are referenced:
  ```html
    <script src="/scripts/offline.bundel.js" type="text/javascript"></script>
    <script src="/scripts/pages/video.bundel.js" type="text/javascript"></script>
  ```
...
31.	Verify that the live.htm file contains the following **&lt;script&gt;** element near the end:
  ```html
    <script src="/scripts/pages/live.bundel.js" type="text/javascript">
  ```
...
35.	Verify that the feedback.htm file contains the following **&lt;script&gt;** elements near the end:
  ```html
    <script src="/scripts/pages/feedback.bundel.js" type="text/javascript">
  ```
