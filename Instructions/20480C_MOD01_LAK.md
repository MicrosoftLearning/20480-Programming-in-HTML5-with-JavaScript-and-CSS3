...
3.	On the Windows 8 **Start** screen, click the **Visual Studio 2017** tile.
4.	In Visual Studio, on the **File** menu, point to **Open**, and then click **Project/Solution**.
5.	In the **Open Project** dialog box, browse to **Allfiles\Mod01\Labfiles\Starter**, click **ContosoConf.sln**, and then click **Open**.
6.	On the **Debug** menu, click **Start Without Debugging**.
7.	In Microsoft Edge, if the message **Intranet settings are turned off by default** appears, click **Don’t show this message** again.
8.	Verify that the **Home** page appears in Microsoft Edge.
