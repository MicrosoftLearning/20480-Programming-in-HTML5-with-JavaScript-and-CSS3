...
3.	In the **Open Project** dialog box, browse to the **Allfiles\Mod06\Labfiles\Starter\Exercise 1** folder, click **ContosoConf.sln**, and then click **Open**.
...
2.	In the **Open Project** dialog box, browse to the **Allfiles\Mod06\Labfiles\Starter\Exercise 2** folder, click **ContosoConf.sln**, and then click **Open**.
...
1.	In Visual Studio, on the **File** menu, point to **Open**, and then click **Open Project/Solution**.
2.	In the **Open Project** dialog box, browse to the **Allfiles\Mod06\Labfiles\Starter\Exercise 3** folder, click **ContosoConf.sln**, and then click **Open**.
