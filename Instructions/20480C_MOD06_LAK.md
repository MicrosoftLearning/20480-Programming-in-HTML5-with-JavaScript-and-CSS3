...
3.	In the **Open Project** dialog box, browse to **Allfiles\Mod06\Labfiles\Starter\Exercise 1**, click **ContosoConf.sln**, and then click **Open**.
...
8.	In Microsoft Edge, if the message **Intranet settings are turned off by default** appears, click **Don’t show this message again**.
