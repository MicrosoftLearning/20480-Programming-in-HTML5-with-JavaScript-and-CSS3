...
6.	In the **Open Project** dialog box, browse to **Allfiles\Mod13\Labfiles\Starter\Exercise 1**, click **ContosoConf.sln**, and then click **Open**.
...
12.	Close Microsoft Edge and return to Visual Studio.
