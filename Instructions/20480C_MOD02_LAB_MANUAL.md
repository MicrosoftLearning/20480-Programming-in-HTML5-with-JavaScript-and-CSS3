...
- Use a **&lt;link&gt;** element inside the page header; set the **href** property to **"styles/site.css"**, set the **rel** property to **"stylesheet"**, and set the **type** property to **"text/css"**.
...
- Set **background-color** property for the web page to **#EAEEFA**, set the list of fonts in the font family to **Calibri**, **Arial**, **sans-serif**, and set the font size **62.5%**
...
- Set the **background-color** property to **#1d1d1d**, set the **line-height** property to **6rem**, and set the **font-size** property to **1.7rem**.
- Additionally, add a style for all links (**&lt;a&gt;** elements) that occur inside a **&lt;nav&gt;** element; set the color property to **#fff** and the **padding** property to **1rem**.
...
- Set the **font-size** property to **4rem**, set the **letter-spacing** property to **-1px**, and set the **margin** property to **1em 0 0,25em 0**.
...
- Set the **padding** property to **0.1rem**, the **max-width** property to **94rem**, and the **margin** property to **0 auto**.
