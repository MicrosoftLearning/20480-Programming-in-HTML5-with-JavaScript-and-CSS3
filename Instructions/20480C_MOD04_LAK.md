...
3.	In the **Open Project** dialog box, go to **Allfiles\Mod04\Labfiles\Starter\Exercise 1**, click **ContosoConf.sln**, and then click **Open**.
...
2.	In the **Open Project** dialog box, go to **Allfiles\Mod04\Labfiles\Start\Exercise 2**, click **ContosoConf.sln**, and then click **Open**.
